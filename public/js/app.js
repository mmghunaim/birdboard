...
/* harmony import */ var _FormBuilder__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FormBuilder */ "./resources/js/components/FormBuilder.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      form: new _FormBuilder__WEBPACK_IMPORTED_MODULE_1__["default"]({
        title: '',
        description: '',
        tasks: [{
          body: ''
  ...
  return _c("div", { staticClass: "dropdown relative" }, [
    ...
    _c(
      "div",
      {
        ...
        staticClass: "dropdown-menu absolute bg-card rounded shadow mt-2",
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.themes, function(color, theme) {
      return _c("button", {
        staticClass:
          "rounded-full w-5 h-5 bg-default border mr-2 focus:outline-none",
...
/***/ "./resources/js/components/FormBuilder.js":
/*!************************************************!*\
  !*** ./resources/js/components/FormBuilder.js ***!
  \************************************************/
/*! exports provided: default */
